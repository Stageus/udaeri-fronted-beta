          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <SC.mainContainer>
              <SC.inquiryContentContainer>
                <SC.topText color={fontColor1}>문의 유형</SC.topText>
                <SC.inquiryCatContainer>
                  {category &&
                    category.map((item, index) => (
                      <SC.inquiryCatBox
                        color={catSelect.find((ele) => ele === item)}
                ...
                <SC.topText color={fontColor1}>이메일</SC.topText>
                ...
                <SC.topText color={fontColor1}>문의 내용</SC.topText>
